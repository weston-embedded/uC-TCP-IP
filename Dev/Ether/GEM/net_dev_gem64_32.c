...
const  NET_DEV_API_ETHER  NetDev_API_GEM64_32 = {                                /* Ether DMA dev API fnct ptrs :*/
                         ...
                         NET_ERR      *p_err)
{
   ...
   *p_data = (CPU_INT08U *)(addr & GEM_RXBUF_ADDR_MASK);        /* Return a pointer to the newly received data area.    */
    ...
    pdesc->AddrHigh = 0u;                                       /* Update the high-order address word.                  */
